...
#ifndef AT_TINY_ISR_TIMER_HPP
#define AT_TINY_ISR_TIMER_HPP

#if ( defined(AT_TINYCORE) || defined(MEGATINYCORE) )

#else
  #error This is designed only for AVRATtiny boards using ATtinyCore or megaTinyCore ! Please check your Tools->Board setting
#endif
